<script>
  ...
  const engineeringTimelineEvents = [
      ...
      },
      {
          ...
          title: "JobCamp",
          blurb: "Created a platform for students to be matched with companies in a job shadowing program for my high school school. Used by over 60 companies and 300 students annually. Originaly built with vue and firebase, I later converted to use svelte, sveltekit and a custom backend with primsa for database management and lucia-auth for login.",
      ...
      },
      {
          date: "September 2020",
          title: "Robot Arm",
          blurb: "Inspired by my visit to Intuit's Da Vinci robot, I built a Robot Arm for the Robotics Merit Badge in Boy Scouts. It used a biking glove with an arduino, gyroscope, and bluetooth module mounted on it as a controller. The robot used an arduino to control the servos, which were powered by a PC power supply I took apart.",
